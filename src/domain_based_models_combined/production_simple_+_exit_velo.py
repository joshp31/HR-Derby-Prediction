...
results_path = ( 
    "results/domain_based_models_combined/production_simple_+_exit_velo_results.txt" 
) 
...
new_result = pd.DataFrame([{
    "model": "Neural Network - Production Simple + Exit Velocity",
...
overall_results = overall_results[
    overall_results["model"] != "Neural Network - Production Simple + Exit Velocity"
]
