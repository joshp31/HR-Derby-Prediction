...
results_path = ( 
    "results/domain_based_models_combined/production_simple_+_batted_ball_quality_results.txt" 
) 
...
new_result = pd.DataFrame([{
    "model": "Neural Network - Production Simple + Batted Ball Quality",
...
overall_results = overall_results[
    overall_results["model"] != "Neural Network - Production Simple + Batted Ball Quality"
]
