...
results_path = ( 
    "results/domain_based_models_combined/forward_sequential_selection_result_results.txt" 
) 
...
new_result = pd.DataFrame([{
    "model": "Neural Network - Forward Sequential Selection Result",
...
overall_results = overall_results[
    overall_results["model"] != "Neural Network - Forward Sequential Selection Result"
]
