...
results_path = ( 
    "results/domain_based_models_combined/exit_velo_+_launch_angle_results.txt" 
) 
...
new_result = pd.DataFrame([{
    "model": "Neural Network - Exit Velocity + Launch Angle",
...
overall_results = overall_results[
    overall_results["model"] != "Neural Network - Exit Velocity + Launch Angle"
]
