...
results_path = ( 
    "results/domain_based_models_combined/production_simple_+_batted_ball_type_results.txt" 
) 
...
new_result = pd.DataFrame([{
    "model": "Neural Network - Production Simple + Batted Ball Type",
...
overall_results = overall_results[
    overall_results["model"] != "Neural Network - Production Simple + Batted Ball Type"
]
