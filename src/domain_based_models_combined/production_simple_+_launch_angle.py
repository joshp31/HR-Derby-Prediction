...
results_path = ( 
    "results/domain_based_models_combined/production_simple_+_launch_angle_results.txt" 
) 
...
new_result = pd.DataFrame([{
    "model": "Neural Network - Production Simple + Launch Angle",
...
overall_results = overall_results[
    overall_results["model"] != "Neural Network - Production Simple + Launch Angle"
]
