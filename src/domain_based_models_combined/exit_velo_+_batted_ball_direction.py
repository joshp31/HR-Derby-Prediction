...
results_path = ( 
    "results/domain_based_models_combined/exit_velo_+_batted_ball_direction_results.txt" 
) 
...
new_result = pd.DataFrame([{
    "model": "Neural Network - Batted Ball Direction + Exit Velocity",
...
overall_results = overall_results[
    overall_results["model"] != "Neural Network - Batted Ball Direction + Exit Velocity"
]
