...
results_path = ( 
    "results/domain_based_models_combined/batted_ball_direction_+_quality_results.txt" 
) 
...
new_result = pd.DataFrame([{
    "model": "Neural Network - Batted Ball Direction + Quality",
...
overall_results = overall_results[
    overall_results["model"] != "Neural Network - Batted Ball Direction + Quality"
]
