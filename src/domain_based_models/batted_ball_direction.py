...
results_path = ( 
    "results/domain_based_models/batted_ball_direction_results.txt" 
) 
...
new_result = pd.DataFrame([{
    "model": "Neural Network - Batted Ball Direction",
...
overall_results = overall_results[
    overall_results["model"] != "Neural Network - Batted Ball Direction"
]
