...
results_path = ( 
    "results/domain_based_models/batted_ball_quality_results.txt" 
) 
...
new_result = pd.DataFrame([{
    "model": "Neural Network - Batted Ball Quality",
...
overall_results = overall_results[
    overall_results["model"] != "Neural Network - Batted Ball Quality"
]
