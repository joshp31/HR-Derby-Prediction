...
results_path = ( 
    "results/model_2/ordinal_logistic_regression_results.txt" 
) 
...
new_result = pd.DataFrame([{
    "model": "Ordinal Logistic Regression - Model 2",
...
overall_results = overall_results[
    overall_results["model"] != "Ordinal Logistic Regression - Model 2"
]
