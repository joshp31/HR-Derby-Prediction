...
df = pd.read_csv(
    "data/gold/statcast_batting/batter_stats_pre_2026.csv"
)
...
def assign_rounds(probabilities):
    """
    Assign the 8 Derby players to rounds while enforcing:
    ...
    The assignment that maximizes the total log probability
    is selected.
    """
...
results_path = (
    "results/model_1/elastic_net_results.txt"
)

with open(results_path, "w") as f:

    f.write("Elastic Net Results\n")
    f.write("==================\n\n")
...
overall_results = overall_results[
    overall_results["model"] != "Elastic Net - Model 1"
]
