...
results_path = ( 
    "results/model_1/ordinal_logistic_regression_results.txt" 
) 
 
with open(results_path, "w") as f: 
 
    f.write("Ordinal Logistic Regression Results\n") 
    f.write("===================================\n\n") 
...
new_result = pd.DataFrame([{
    "model": "Ordinal Logistic Regression - Model 1",
...
overall_results = overall_results[
    overall_results["model"] != "Ordinal Logistic Regression - Model 1"
]
